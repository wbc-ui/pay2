...
<p align="center">
<a href="https://www.npmjs.com/package/@wbc-ui/pay2"><img src="https://img.shields.io/npm/v/@wbc-ui/pay2?color=1976D2" alt="npm"></a>
<a href="https://www.npmjs.com/package/@wbc-ui/pay2?activeTab=versions"><img src="https://img.shields.io/npm/dm/@wbc-ui/pay2?color=1976D2" alt="downloads"></a>
<a href="https://github.com/wbc-ui/pay2/blob/main/LICENSE"><img src="https://img.shields.io/npm/l/@wbc-ui/pay2?color=blue" alt="license"></a>
...
**@wbc-ui/pay2** replaces the bespoke "Support me / Buy me a coffee / Donate crypto" page that every OSS maintainer and indie dev rewrites from scratch.
...
A **Vue 2.7+ component** that renders a polymorphic payment-provider grid from a single array of plain JSON descriptors. Pairs with `@wbc-ui/core2` but is independently installable.
...
]" :product="'wb-code'" :recipient="{ name: 'Wissem', contactEmail: 'me@wbc-ui.com' }" />
```
...
- **Vue 2.7.x** (the component targets Vue 2 specifically; Vue 3 support tracked separately as `@wbc-ui/pay3`)
...
```bash
# Yarn
yarn add @wbc-ui/pay2
yarn add vue@^2.7.16 vuetify@^2.7.2

# pnpm
pnpm add @wbc-ui/pay2
...
import Vue from 'vue';
import { WbPayHub } from '@wbc-ui/pay2';
...
### Pairs with @wbc-ui/core2

```javascript
// If you already use @wbc-ui/core2, WbPayHub can render inside a <WBC> tree:
<WBC :item="{
  comp: 'WbPayHub',
  options: {
...
| `Cannot find module '@wbc-ui/pay2'` | npm couldn't resolve the package | Confirm install: `npm ls @wbc-ui/pay2`. If empty, `npm install @wbc-ui/pay2@latest`. |
...
`@wbc-ui/pay2` is a sibling package in the **@wbc-ui** monorepo. Every package is published to npm and shares the same versioning line.
